...
const VButton2 = ({ children }) => {
    ...
    return (
        <button className="group bg-orange-400 w-28 h-10 rounded-full text-md flex items-center justify-center text-white overflow-hidden">
            ...
            <span className=" bg-white rounded-full w-2 h-32 -translate-x-3 opacity-0 
             flex items-center justify-center 
             group-hover:w-6 group-hover:opacity-100  group-hover:h-6  group-hover:translate-x-2
